...
class database_module(object):
    ...
    def load_data_list(self):
        ...
        for spe in self.database_dict_species.keys():
            ...
            if spe_filepaths_len >= self.max_sample:
                self.database_dict_species_counter[spe] = self.max_sample
            else:
    ...
    def predefine_dataset(self):
        ...
        if status == False:
            ...
            max_negative_len = int(0.5 * len(self.predefined_filepaths))
            if max_negative_len > int(0.5 * len(self.data_paths)):
                max_negative_len = int(0.5 * len(self.data_paths))
        ...
        if positive_percentage < 0.5:
            positive_overall = 0.5 * current_predefined_filepaths_len
